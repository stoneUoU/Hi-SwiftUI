...
/** 设置角标数字
 @warning  APP角标显示需额外调用 [[UIApplication sharedApplication] setApplicationIconBadgeNumber:badge] 进行设置
 @param badge 角标数量
 */
+ (void)setBadge:(int)badge response:(void (^__nonnull)(id __nullable responseObject, NSError * __nullable error))handle;
